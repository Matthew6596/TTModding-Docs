...
## Nu2 Engine
Whilst all TT-produced mainline console and PC video games from **Crash Bandicoot: The Wrath of Cortex** to **The LEGO Movie 2 Videogame** run on the same underlying engine, the engine itself has undergone several iterations over the years.
